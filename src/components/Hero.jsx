...
function Hero() {
  return (
    <section>
      <div className="flex flex-col justify-center items-center py-20 border-b-2 border-black px-4 mx-auto">
        <span className="capitalize text-xl mb-4 text-center">
          World's best online blog app
        </span>
        <h1 className="capitalize text-6xl font-bold mb-6 text-center leading-[130%]">
          where all posibilities{" "}
          <span className="bg-gradient-to-t from-[#000957] to-[#344CB7] bg-clip-text text-transparent font-bold">
            Meet
          </span>
        </h1>
        <p className="text-[20px] text-center capitalize">
